...
export const fetchGetPod = async (name: string, namespace: string, clusterCtx: string) =>
  GetPod(name, namespace, clusterCtx)
export const fetchUpdatePod = async (
  name: string,
  namespace: string,
  dto: any,
  clusterCtx: string,
...
export const fetchUpdateDeployment = async (
  name: string,
  namespace: string,
  dto: any,
  clusterCtx: string,
...
export const fetchTroubleshootPod = async (name: string, namespace: string, clusterCtx: string) =>
  TroubleshootPod(name, namespace, clusterCtx)
export const fetchTroubleshootDeployment = async (
  name: string,
  namespace: string,
  clusterCtx: string,
